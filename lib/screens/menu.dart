...
import 'package:floryn_shop/widgets/product_card.dart';
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 254, 240, 255),
      // AppBar adalah bagian atas halaman yang menampilkan judul.
      appBar: AppBar(
        // Judul aplikasi "Floryn Shop" dengan teks putih dan tebal.
        title: const Text(
          'Floryn Shop',
          style: TextStyle(
            color: Colors.white,
